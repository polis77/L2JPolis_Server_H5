...
import com.polis.gameserver.Announcements;
import com.polis.gameserver.GameTimeController;
import com.polis.gameserver.GeoData;
import com.polis.gameserver.ItemsAutoDestroy;
import com.polis.gameserver.LoginServerThread;
import com.polis.gameserver.RecipeController;
import com.polis.gameserver.SevenSigns;
import com.polis.gameserver.SevenSignsFestival;
import com.polis.gameserver.ThreadPoolManager;
import com.polis.gameserver.ai.CtrlIntention;
import com.polis.gameserver.ai.L2CharacterAI;
import com.polis.gameserver.ai.L2PlayerAI;
import com.polis.gameserver.ai.L2SummonAI;
import com.polis.gameserver.cache.HtmCache;
import com.polis.gameserver.cache.WarehouseCacheManager;
import com.polis.gameserver.communitybbs.BB.Forum;
import com.polis.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.polis.gameserver.communitybbs.Manager.RegionBBSManager;
...
import com.polis.gameserver.enums.HtmlActionScope;
import com.polis.gameserver.enums.IllegalActionPunishmentType;
import com.polis.gameserver.enums.InstanceType;
import com.polis.gameserver.enums.MountType;
import com.polis.gameserver.enums.PartyDistributionType;
import com.polis.gameserver.enums.PlayerAction;
import com.polis.gameserver.enums.PrivateStoreType;
import com.polis.gameserver.enums.Race;
import com.polis.gameserver.enums.Sex;
import com.polis.gameserver.enums.ShortcutType;
import com.polis.gameserver.enums.ShotType;
import com.polis.gameserver.enums.Team;
import com.polis.gameserver.handler.IItemHandler;
import com.polis.gameserver.handler.ItemHandler;
...
import com.polis.gameserver.instancemanager.DuelManager;
...
import com.polis.gameserver.instancemanager.HandysBlockCheckerManager;
...
import com.polis.gameserver.model.ArenaParticipantsHolder;
import com.polis.gameserver.model.BlockList;
import com.polis.gameserver.model.ClanPrivilege;
import com.polis.gameserver.model.L2AccessLevel;
import com.polis.gameserver.model.L2Clan;
import com.polis.gameserver.model.L2ClanMember;
import com.polis.gameserver.model.L2ContactList;
import com.polis.gameserver.model.L2EnchantSkillLearn;
import com.polis.gameserver.model.L2ManufactureItem;
import com.polis.gameserver.model.L2Object;
import com.polis.gameserver.model.L2Party;
import com.polis.gameserver.model.L2Party.messageType;
import com.polis.gameserver.model.L2PetData;
import com.polis.gameserver.model.L2PetLevelData;
import com.polis.gameserver.model.L2PremiumItem;
import com.polis.gameserver.model.L2Radar;
import com.polis.gameserver.model.L2RecipeList;
import com.polis.gameserver.model.L2Request;
import com.polis.gameserver.model.L2SkillLearn;
import com.polis.gameserver.model.L2World;
import com.polis.gameserver.model.L2WorldRegion;
import com.polis.gameserver.model.Location;
import com.polis.gameserver.model.Macro;
import com.polis.gameserver.model.MacroList;
import com.polis.gameserver.model.PartyMatchRoom;
...
import com.polis.gameserver.model.ShortCuts;
import com.polis.gameserver.model.Shortcut;
import com.polis.gameserver.model.TeleportBookmark;
import com.polis.gameserver.model.TeleportWhereType;
import com.polis.gameserver.model.TerritoryWard;
import com.polis.gameserver.model.TimeStamp;
import com.polis.gameserver.model.TradeList;
import com.polis.gameserver.model.UIKeysSettings;
import com.polis.gameserver.model.actor.L2Attackable;
import com.polis.gameserver.model.actor.L2Character;
import com.polis.gameserver.model.actor.L2Decoy;
import com.polis.gameserver.model.actor.L2Npc;
import com.polis.gameserver.model.actor.L2Playable;
import com.polis.gameserver.model.actor.L2Summon;
import com.polis.gameserver.model.actor.L2Vehicle;
import com.polis.gameserver.model.actor.appearance.PcAppearance;
import com.polis.gameserver.model.actor.knownlist.PcKnownList;
import com.polis.gameserver.model.actor.stat.PcStat;
import com.polis.gameserver.model.actor.status.PcStatus;
import com.polis.gameserver.model.actor.tasks.player.DismountTask;
import com.polis.gameserver.model.actor.tasks.player.FameTask;
import com.polis.gameserver.model.actor.tasks.player.GameGuardCheckTask;
import com.polis.gameserver.model.actor.tasks.player.InventoryEnableTask;
import com.polis.gameserver.model.actor.tasks.player.LookingForFishTask;
import com.polis.gameserver.model.actor.tasks.player.PetFeedTask;
import com.polis.gameserver.model.actor.tasks.player.PvPFlagTask;
import com.polis.gameserver.model.actor.tasks.player.RecoBonusTaskEnd;
import com.polis.gameserver.model.actor.tasks.player.RecoGiveTask;
import com.polis.gameserver.model.actor.tasks.player.RentPetTask;
import com.polis.gameserver.model.actor.tasks.player.ResetChargesTask;
import com.polis.gameserver.model.actor.tasks.player.ResetSoulsTask;
import com.polis.gameserver.model.actor.tasks.player.SitDownTask;
import com.polis.gameserver.model.actor.tasks.player.StandUpTask;
import com.polis.gameserver.model.actor.tasks.player.TeleportWatchdogTask;
import com.polis.gameserver.model.actor.tasks.player.VitalityTask;
import com.polis.gameserver.model.actor.tasks.player.WarnUserTakeBreakTask;
import com.polis.gameserver.model.actor.tasks.player.WaterTask;
import com.polis.gameserver.model.actor.templates.L2NpcTemplate;
import com.polis.gameserver.model.actor.templates.L2PcTemplate;
import com.polis.gameserver.model.actor.transform.Transform;
import com.polis.gameserver.model.base.ClassId;
import com.polis.gameserver.model.base.ClassLevel;
import com.polis.gameserver.model.base.PlayerClass;
import com.polis.gameserver.model.base.SubClass;
...
import com.polis.gameserver.model.entity.Duel;
import com.polis.gameserver.model.entity.Fort;
import com.polis.gameserver.model.entity.Hero;
import com.polis.gameserver.model.entity.Instance;
import com.polis.gameserver.model.entity.L2Event;
import com.polis.gameserver.model.entity.Siege;
...
import com.polis.gameserver.model.events.impl.character.player.OnPlayerEquipItem;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerFameChanged;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerHennaRemove;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerKarmaChanged;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerLogin;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerLogout;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerPKChanged;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerProfessionChange;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerPvPChanged;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerPvPKill;
import com.polis.gameserver.model.events.impl.character.player.OnPlayerTransform;
import com.polis.gameserver.model.events.listeners.AbstractEventListener;
import com.polis.gameserver.model.fishing.L2Fish;
import com.polis.gameserver.model.fishing.L2Fishing;
import com.polis.gameserver.model.holders.ItemHolder;
import com.polis.gameserver.model.holders.PlayerEventHolder;
import com.polis.gameserver.model.holders.SkillUseHolder;
import com.polis.gameserver.model.interfaces.IEventListener;
import com.polis.gameserver.model.interfaces.ILocational;
import com.polis.gameserver.model.itemcontainer.Inventory;
import com.polis.gameserver.model.itemcontainer.ItemContainer;
import com.polis.gameserver.model.itemcontainer.PcFreight;
import com.polis.gameserver.model.itemcontainer.PcInventory;
import com.polis.gameserver.model.itemcontainer.PcRefund;
import com.polis.gameserver.model.itemcontainer.PcWarehouse;
import com.polis.gameserver.model.itemcontainer.PetInventory;
import com.polis.gameserver.model.items.L2Armor;
import com.polis.gameserver.model.items.L2EtcItem;
import com.polis.gameserver.model.items.L2Henna;
import com.polis.gameserver.model.items.L2Item;
import com.polis.gameserver.model.items.L2Weapon;
import com.polis.gameserver.model.items.instance.L2ItemInstance;
import com.polis.gameserver.model.items.type.ActionType;
import com.polis.gameserver.model.items.type.ArmorType;
import com.polis.gameserver.model.items.type.EtcItemType;
import com.polis.gameserver.model.items.type.WeaponType;
import com.polis.gameserver.model.multisell.PreparedListContainer;
import com.polis.gameserver.model.olympiad.OlympiadGameManager;
import com.polis.gameserver.model.olympiad.OlympiadGameTask;
import com.polis.gameserver.model.olympiad.OlympiadManager;
import com.polis.gameserver.model.punishment.PunishmentAffect;
import com.polis.gameserver.model.punishment.PunishmentType;
import com.polis.gameserver.model.quest.Quest;
import com.polis.gameserver.model.quest.QuestState;
import com.polis.gameserver.model.quest.State;
import com.polis.gameserver.model.skills.AbnormalType;
import com.polis.gameserver.model.skills.BuffInfo;
import com.polis.gameserver.model.skills.CommonSkill;
...
import com.polis.gameserver.model.stats.Stats;
import com.polis.gameserver.model.variables.AccountVariables;
import com.polis.gameserver.model.variables.PlayerVariables;
import com.polis.gameserver.model.zone.L2ZoneType;
import com.polis.gameserver.model.zone.ZoneId;
import com.polis.gameserver.model.zone.type.L2BossZone;
...
import com.polis.gameserver.network.communityserver.writepackets.WorldInfo;
import com.polis.gameserver.network.serverpackets.AbstractHtmlPacket;
import com.polis.gameserver.network.serverpackets.ActionFailed;
import com.polis.gameserver.network.serverpackets.ChangeWaitType;
import com.polis.gameserver.network.serverpackets.CharInfo;
import com.polis.gameserver.network.serverpackets.ConfirmDlg;
import com.polis.gameserver.network.serverpackets.EtcStatusUpdate;
import com.polis.gameserver.network.serverpackets.ExAutoSoulShot;
import com.polis.gameserver.network.serverpackets.ExBrExtraUserInfo;
import com.polis.gameserver.network.serverpackets.ExDominionWarStart;
import com.polis.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.polis.gameserver.network.serverpackets.ExFishingEnd;
import com.polis.gameserver.network.serverpackets.ExFishingStart;
import com.polis.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import com.polis.gameserver.network.serverpackets.ExGetOnAirShip;
import com.polis.gameserver.network.serverpackets.ExOlympiadMode;
import com.polis.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import com.polis.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.polis.gameserver.network.serverpackets.ExStartScenePlayer;
import com.polis.gameserver.network.serverpackets.ExStorageMaxCount;
import com.polis.gameserver.network.serverpackets.ExUseSharedGroupItem;
import com.polis.gameserver.network.serverpackets.FlyToLocation.FlyType;
import com.polis.gameserver.network.serverpackets.FriendStatusPacket;
import com.polis.gameserver.network.serverpackets.GameGuardQuery;
import com.polis.gameserver.network.serverpackets.GetOnVehicle;
import com.polis.gameserver.network.serverpackets.HennaInfo;
import com.polis.gameserver.network.serverpackets.InventoryUpdate;
import com.polis.gameserver.network.serverpackets.ItemList;
import com.polis.gameserver.network.serverpackets.L2GameServerPacket;
import com.polis.gameserver.network.serverpackets.LeaveWorld;
import com.polis.gameserver.network.serverpackets.MagicSkillUse;
import com.polis.gameserver.network.serverpackets.MyTargetSelected;
import com.polis.gameserver.network.serverpackets.NicknameChanged;
import com.polis.gameserver.network.serverpackets.NpcHtmlMessage;
import com.polis.gameserver.network.serverpackets.ObservationMode;
import com.polis.gameserver.network.serverpackets.ObservationReturn;
import com.polis.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.polis.gameserver.network.serverpackets.PetInventoryUpdate;
import com.polis.gameserver.network.serverpackets.PlaySound;
import com.polis.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.polis.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.polis.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.polis.gameserver.network.serverpackets.PrivateStoreListSell;
import com.polis.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import com.polis.gameserver.network.serverpackets.PrivateStoreManageListSell;
import com.polis.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import com.polis.gameserver.network.serverpackets.PrivateStoreMsgSell;
import com.polis.gameserver.network.serverpackets.RecipeShopMsg;
import com.polis.gameserver.network.serverpackets.RecipeShopSellList;
import com.polis.gameserver.network.serverpackets.RelationChanged;
import com.polis.gameserver.network.serverpackets.Ride;
import com.polis.gameserver.network.serverpackets.ServerClose;
import com.polis.gameserver.network.serverpackets.SetupGauge;
import com.polis.gameserver.network.serverpackets.ShortCutInit;
import com.polis.gameserver.network.serverpackets.SkillCoolTime;
import com.polis.gameserver.network.serverpackets.SkillList;
import com.polis.gameserver.network.serverpackets.Snoop;
import com.polis.gameserver.network.serverpackets.SocialAction;
import com.polis.gameserver.network.serverpackets.StatusUpdate;
import com.polis.gameserver.network.serverpackets.StopMove;
import com.polis.gameserver.network.serverpackets.SystemMessage;
import com.polis.gameserver.network.serverpackets.TargetSelected;
import com.polis.gameserver.network.serverpackets.TargetUnselected;
import com.polis.gameserver.network.serverpackets.TradeDone;
import com.polis.gameserver.network.serverpackets.TradeOtherDone;
import com.polis.gameserver.network.serverpackets.TradeStart;
import com.polis.gameserver.network.serverpackets.UserInfo;
import com.polis.gameserver.network.serverpackets.ValidateLocation;
import com.polis.gameserver.taskmanager.AttackStanceTaskManager;
import com.polis.gameserver.util.Broadcast;
import com.polis.gameserver.util.FloodProtectors;
import com.polis.gameserver.util.Util;
import com.polis.util.EnumIntBitmask;
import com.polis.util.Rnd;
