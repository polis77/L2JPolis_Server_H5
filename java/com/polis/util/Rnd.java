...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see com.polis.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link com.polis.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see com.polis.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see com.polis.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see com.polis.util.Rnd#get(int n)
	 */
