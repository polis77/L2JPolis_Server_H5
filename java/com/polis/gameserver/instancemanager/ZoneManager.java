...
import com.polis.gameserver.engines.DocumentParser;
...
import com.polis.gameserver.model.zone.AbstractZoneSettings;
import com.polis.gameserver.model.zone.L2ZoneForm;
import com.polis.gameserver.model.zone.L2ZoneRespawn;
import com.polis.gameserver.model.zone.L2ZoneType;
import com.polis.gameserver.model.zone.form.ZoneCuboid;
import com.polis.gameserver.model.zone.form.ZoneCylinder;
import com.polis.gameserver.model.zone.form.ZoneNPoly;
import com.polis.gameserver.model.zone.type.L2ArenaZone;
import com.polis.gameserver.model.zone.type.L2OlympiadStadiumZone;
import com.polis.gameserver.model.zone.type.L2RespawnZone;
import com.polis.gameserver.model.zone.type.NpcSpawnTerritory;
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("com.polis.gameserver.model.zone.type.L2" + zoneType);
